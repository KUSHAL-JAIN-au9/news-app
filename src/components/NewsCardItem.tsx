...
const NewsCardItem: React.FC<NewsCardItemProps> = ({ title, description, imageUrl, articleUrl }) => {
    ...
    return (<div className="card card-compact min-h-[20rem] mx-4 my-4 w-72 sm:w-96 overflow-hidden shadow-slate-400 bg-gray-800 text-white dark:shadow-white dark:bg-gray-900">
        <figure>
            {!isImageBroken ? <img
        ...
        <div className="card-body">
            ...
            <p className='text-gray-400 text-base'>{truncateString(description, 150)}</p>
